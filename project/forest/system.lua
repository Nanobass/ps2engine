local sky = Graphics.loadImage("forest/10_Sky.png")
local houses4 = Graphics.loadImage("forest/09_Forest.png")
local houses3 = Graphics.loadImage("forest/08_Forest.png")
local houses2 = Graphics.loadImage("forest/07_Forest.png")
local houses1 = Graphics.loadImage("forest/06_Forest.png")
local wall = Graphics.loadImage("forest/05_Particles.png")
local road = Graphics.loadImage("forest/04_Forest.png")
local cracks1 = Graphics.loadImage("forest/03_Particles.png")
local cracks2 = Graphics.loadImage("forest/02_Bushes.png")
local mist = Graphics.loadImage("forest/01_Mist.png")
